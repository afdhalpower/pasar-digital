...
Route::get('/kontak', [ContactController::class, 'showForm'])->name('contact');
Route::post('/kontak', [ContactController::class, 'submit'])->middleware('throttle:3,10');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/email/resend', [EmailVerificationController::class, 'send'])->name('verification.send');
