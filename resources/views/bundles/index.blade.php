...
<section style="padding-top: 120px; padding-bottom: var(--space-4);">
    <div class="container">
        <h1 class="headline-md" style="margin-bottom: var(--space-2);">Bundel Produk</h1>
        <p class="body-md" style="color: var(--color-on-surface-variant);">Dapatkan produk digital favorit dengan harga lebih hemat</p>
    </div>
</section>
    ...
    <div class="container">
            ...
            <div class="bundle-card" style="background: var(--color-surface-container-high); border: 1px solid var(--color-outline-variant); border-radius: var(--radius-xl); padding: var(--space-5); margin-bottom: var(--space-5);">
                <div style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: var(--space-4);">
                    <div style="flex: 1; min-width: 200px;">
                        ...
                        <div style="display: flex; align-items: center; gap: var(--space-3); flex-wrap: wrap;">
                            ...
                            <span class="chip chip-success">Hemat {{ $bundle->discountPercentage() }}%</span>
                        </div>
                    </div>
                ...
                @if($bundle->products->isNotEmpty())
                    <div style="margin-top: var(--space-4); padding-top: var(--space-4); border-top: 1px solid var(--color-outline-variant);">
                        <p class="body-sm" style="font-weight: 600; color: var(--color-on-surface); margin-bottom: var(--space-2);">Termasuk:</p>
        ...
        @empty
            <div style="text-align:center; padding:80px 0;">
                ...
                <h3 class="headline-sm" style="margin-bottom:8px;">Belum ada bundel tersedia</h3>
                <p class="body-md" style="color:var(--color-on-surface-variant);">Kami sedang menyiapkan bundel produk spesial untuk Anda.</p>
            </div>
        @endforelse
