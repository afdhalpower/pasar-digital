    ...
    <div style="display: grid; grid-template-columns: 280px 1fr; gap: var(--space-5);" class="dashboard-grid">
        ...
        <main class="dashboard-content-area animate-in">
            <div style="margin-bottom: var(--space-4);">
                <span class="label-sm" style="color: var(--color-primary);">Selamat Datang Kembali</span>
                <h1 class="headline-md" style="margin-top: 4px;">Halo, {{ auth()->user()->name }}!</h1>
                <p style="color: var(--color-on-surface-variant); font-size: 0.875rem;">Berikut ringkasan akun Anda hari ini.</p>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: var(--space-3); margin-bottom: var(--space-5);">
                <div class="metric-card">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                        <span style="font-size: 0.875rem; color: var(--color-on-surface-variant); font-weight: 500;">Total Pengeluaran</span>
                    ...
                    <span style="font-size: 0.75rem; color: var(--color-on-surface-variant);">Dari transaksi yang sukses</span>
                </div>

                <div class="metric-card">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                        <span style="font-size: 0.875rem; color: var(--color-on-surface-variant); font-weight: 500;">Pesanan Aktif</span>
                    ...
                    <span style="font-size: 0.75rem; color: var(--color-on-surface-variant);">Menunggu verifikasi pembayaran</span>
                </div>

                <div class="metric-card">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 12px;">
                        <span style="font-size: 0.875rem; color: var(--color-on-surface-variant); font-weight: 500;">Total Produk Saya</span>
                    ...
                    <span style="font-size: 0.75rem; color: var(--color-on-surface-variant);">Produk siap diunduh</span>
                </div>
            </div>
            ...
            <div style="background: var(--color-surface-container); border: 1px solid var(--color-outline-variant); border-radius: var(--radius-lg); padding: var(--space-4); margin-bottom: var(--space-5);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                    <h3 class="headline-sm" style="font-size: 1.25rem;">Pesanan Terakhir</h3>
                    <a href="{{ route('buyer.orders') }}" style="color: var(--color-primary); font-size: 0.875rem; font-weight: 600; text-decoration: none;">Lihat Semua</a>
                </div>
            ...
            <div style="background: var(--color-surface-container); border: 1px solid var(--color-outline-variant); border-radius: var(--radius-lg); padding: var(--space-4);">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                    <h3 class="headline-sm" style="font-size: 1.25rem;">Unduhan Terbaru</h3>
                    <a href="{{ route('buyer.downloads') }}" style="color: var(--color-primary); font-size: 0.875rem; font-weight: 600; text-decoration: none;">Lihat Semua</a>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(240px, 1fr)); gap: 16px;">
                        ...
                        @if ($item->product)
                            <div style="background: var(--color-surface-container-high); border: 1px solid var(--color-outline-variant); border-radius: var(--radius-md); padding: 16px; display: flex; flex-direction: column; justify-content: space-between; height: 160px; transition: all 0.3s;" onmouseover="this.style.borderColor='var(--color-primary)'" onmouseout="this.style.borderColor='var(--color-outline-variant)'">
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 12px;">
                                    <span style="font-size: 0.75rem; color: var(--color-on-surface-variant);">Beli: {{ $item->created_at->format('d/m/y') }}</span>
                    ...
                    @empty
                        <div style="grid-column: 1/-1; text-align: center; padding: 30px 0; color: var(--color-on-surface-variant); font-size: 0.875rem;">
                            Belum ada produk yang siap diunduh.
                        </div>
                    @endforelse
                </div>
            </div>
